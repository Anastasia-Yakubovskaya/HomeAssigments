...
std::string Transformer::getModel() const
{
    return model;
}
void Transformer::setModel(std::string newModel)
{
    model = newModel;
}
...
void Transformer::setPower(int newPower)
{
    power = newPower;
}
std::string Transformer::getWeaponType() const
{
    return weapon.getType();
}
int Transformer::getWeaponDamage() const
{
